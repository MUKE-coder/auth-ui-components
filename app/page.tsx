...
export default function DocsPage() {
  ...
  const components = [
    {
      name: "SignIn",
      path: "/auth/sign-in",
      description: "Email/password login with Google & GitHub OAuth",
    },
    {
      name: "SignUp",
      path: "/auth/sign-up",
    ...
    },
    {
      ...
      description: "6-digit OTP verification with resend",
    },
    {
      name: "ForgetPassword",
    ...
    },
    {
      name: "LogoutButton",
      path: "/dashboard",
      description: "Configurable logout button",
    },
  ];
  ...
  const features = [
    ...
    },
    {
      icon: Code2,
      title: "Type Safe",
      description: "Written in TypeScript with Zod validation schemas",
    },
  ];
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            A complete set of authentication UI components for Next.js. Built
            with shadcn/ui, React Hook Form, and Zod. Ready to use with Better
            Auth.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            <div className="relative w-full max-w-2xl">
              <div className="flex items-center gap-2 bg-muted rounded-lg p-2 pl-4 font-mono text-sm">
                <code className="flex-1 text-left truncate">
                ...
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    copyToClipboard(commands[packageManager].install)
                  }
                  className="shrink-0"
                >
                  {copied ? (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-background rounded-lg p-6 border">
              ...
              <p className="text-muted-foreground mb-4">
                Copy the generated .env.example to .env.local and fill in your
                values:
              </p>
      ...
      sendVerificationOTP: async ({ email, otp }) => {
        // Send email with OTP
            ...
            <div className="bg-background rounded-lg p-6 border">
              ...
              <p className="text-muted-foreground mb-4">
                Auth pages are automatically created in app/(auth)/auth/. You
                can also import components directly:
              </p>
              <div className="bg-muted rounded-lg p-4 font-mono text-sm overflow-x-auto">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 border rounded-lg">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-center gap-2">
                  <Check className="h-4 w-4 text-green-500" /> SignIn with
                  social OAuth
                </li>
                <li className="flex items-center gap-2">
                  <Check className="h-4 w-4 text-green-500" /> SignUp with email
                  verification
                </li>
                <li className="flex items-center gap-2">
                  <Check className="h-4 w-4 text-green-500" /> VerifyEmail with
                  OTP input
                </li>
                <li className="flex items-center gap-2">
                  <Check className="h-4 w-4 text-green-500" /> Password reset
                  flow
                </li>
                <li className="flex items-center gap-2">
                  <Check className="h-4 w-4 text-green-500" /> Profile
                  management
                </li>
                <li className="flex items-center gap-2">
                  <Check className="h-4 w-4 text-green-500" /> LogoutButton
                  component
                </li>
              </ul>
            </div>
            <div className="p-6 border rounded-lg">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-center gap-2">
                  <Check className="h-4 w-4 text-green-500" /> Auth client
                  configuration
                </li>
                <li className="flex items-center gap-2">
                  <Check className="h-4 w-4 text-green-500" /> Zod validation
                  schemas
                </li>
                <li className="flex items-center gap-2">
                  <Check className="h-4 w-4 text-green-500" /> TypeScript types
                </li>
                <li className="flex items-center gap-2">
                  <Check className="h-4 w-4 text-green-500" /> Icon components
                </li>
                <li className="flex items-center gap-2">
                  <Check className="h-4 w-4 text-green-500" /> Toast
                  notifications
                </li>
                <li className="flex items-center gap-2">
                  <Check className="h-4 w-4 text-green-500" /> Loading states
                </li>
              </ul>
            </div>
          </div>
